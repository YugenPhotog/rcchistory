# Chapter 4 Cognitive-Load Audit
...
| Concise stems | Pass | Longest stem: 140 characters; each stem contains one central task. |
...
| Scaffolding | Pass | Default is `mid`; URL override supports early, mid, and late. Hints appear only in early mode; late mode reveals the move after submission. |
